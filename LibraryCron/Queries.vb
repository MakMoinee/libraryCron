Module Queries
    ...
    Public ReadOnly smsTemplate As String = "Hi {0}," + vbLf + "the book/non-printed material you had borrowed on {1} is due today {2}." + vbLf + "Please return it on time." + vbLf + "Thank You!"
