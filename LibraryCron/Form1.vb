...
Public Class Form1
    ...
    Private Sub loadService()
        If runInBG Then
            ...
            regKey.SetValue("LibraryCronJob", "D:\LibraryCron\LibraryCron\bin\Debug\net6.0-windows\LibraryCron.exe /background")
            regKey.Close()
                    ...
                    For i As Integer = 0 To list.Count - 1
                        ...
                        If rBook.getCategory().ToLower().Equals("textbook") Then
                            ...
                            If betweenDays = 1 Then
                                ...
                                Try
                                    Dim result = SMP(smsApiKey, rBook.getContactNumber, Message, "SEMAPHORE")
